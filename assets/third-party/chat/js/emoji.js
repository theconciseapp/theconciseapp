  ...
  $.fn.oluEmoji = function (options) {
  // Overriding default options
    settings = $.extend({
      width: 220,
      height: 200,
      height2: 'calc(100% - 35px)',
      max_height: '65vh',
     ...
     var appender = $('<div></div>')
       ...
       var container = $('<div></div>')
         .addClass('lsx-emojipicker-container')
                .css({ 'height': (settings.height + 30),'max-height': settings.max_height });
            ...
            var emojiPeopleContainer = $('<div></div>')
                ...
                .css({'width': settings.width, 'height': settings.height2});
           ...
           this.click(function(e){
              e.preventDefault();
               if( 
                  ...
                  && !$(e.target).hasClass('lsx-emojipicker-tabs')            
                  && !$(e.target).parent().hasClass('lsx-emoji-tab')
                  && !$(e.target).parent().parent().hasClass('lsx-emoji-tab')
                  && !$(e.target).parent().hasClass('lsx-emojipicker-wrapper')  ){
