...
var id=randomString(10);
 ...
 if(dn && $.inArray(key,dn_)!==-1 )  $('.a_' + id + key + '_' + num).html('<img src="' + _BASE_URL_ + '/images/mark_' + (num<3?'fail':'success') + '.png" style="height:16px; width: 16px;">');
    else if(!dn) $('.a_' + id + key + '_' + num).html('<img src="' + _BASE_URL_ + '/images/mark_' + (num<3?'fail':'success') + '.png" style="height:16px; width: 16px;" class="mark_icon">');
...
function psymotors_(elem,xdata){
 ...
 if(key in psy_){
    var num=+psy_[key];
   $('.b_' + id + key + '_' + num).html('<img src="' + _BASE_URL_ + '/images/mark_' + (num<3?'fail':'success') + '.png" style="height:16px; width: 16px;" class="mark_icon">');
      }
  });
